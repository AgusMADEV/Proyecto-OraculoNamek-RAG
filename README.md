...
# Oráculo Namek - Dragon Ball Z RAG

**Motor de búsqueda semántica sobre el universo de Dragon Ball Z con ChromaDB + Ollama**
...
Consulta información sobre personajes, sagas, técnicas y transformaciones de Dragon Ball Z mediante búsqueda semántica y respuestas RAG con fuentes, todo desde una interfaz web moderna con dark mode.
...
templates/ + static/   SPA  (HTML + CSS + JS vanilla)
    |
corpus/            Documentos sobre Dragon Ball Z (.md)
...
```bash
# 1. Clonar
git clone https://github.com/agusmadev/Oraculo-Namek-RAG.git
cd Oraculo-Namek-RAG
...
Oraculo-Namek-RAG/
  ...
  corpus/              Documentos sobre Dragon Ball Z
    *.md
...
| `DEFAULT_COLLECTION`    | `oraculo_namek`          | Nombre de la coleccion ChromaDB   |
...
**Agustín Morcillo** -- [github.com/agusmadev](https://github.com/agusmadev)

---

<div align="center">
<sub>ShenronGPT - Oráculo Namek -- Retrieval Augmented Generation sobre Dragon Ball Z con ChromaDB + Ollama</sub>
</div>
